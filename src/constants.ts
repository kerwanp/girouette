export const REFLECT_ROUTES_KEY = '__girouette_routes__'

export const REFLECT_RESOURCE_KEY = '__girouette_resource__'

export const REFLECT_RESOURCE_NAME_KEY = '__girouette_resource_name__'
export const REFLECT_RESOURCE_PARAMS_KEY = '__girouette_resource_params__'
